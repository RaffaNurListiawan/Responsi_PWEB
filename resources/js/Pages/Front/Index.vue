...
<template>
  ...
  <nav class="bg-white border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between lg:mx-32 p-4">
      <a href="https://instagram.com/raffalstwn?igshid=MzNlNGNkZWQ4Mg==" class="flex items-center">
        <img src="../../Components/images/logo.png" class="h-8 mr-3" alt="Raffa" />
      </a>
      <button
    ...
    <div class="container px-5 py-5">
      <div class="flex flex-col-reverse lg:flex-row items-center lg:py-5 lg:order-first">
        <div class="lg:w-6/12 lg:ms-10 text-black">
          ...
          <p>
            WEB ini dibuat hanya untuk bersenang-senang hehe.
          </p>
          <p>
            NB : jangan lupa pencet logo atas.
          </p>
      ...
      <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
        <div className="sm:col-span-12 lg:col-span-3">
          ...
          <div className="text-sm text-gray-600">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-black uppercase">Raffa Nur Listiawan</span>
          </div>
        </div>
